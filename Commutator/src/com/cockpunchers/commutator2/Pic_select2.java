...
public class Pic_select2 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		un=ParseUser.getCurrentUser().getString("username");
	...
	set.setOnClickListener(new View.OnClickListener() {
		...
		public void onClick(View v) {
			...
			if(bitmap==null)
			{
				bitmap=BitmapFactory.decodeResource(getResources(), R.drawable.default_medium_profile_pic);
				ByteArrayOutputStream stream = new ByteArrayOutputStream();
		        // Compress image to lower quality scale 1 - 100
		        bitmap.compress(Bitmap.CompressFormat.PNG, 100, stream);
		        image = stream.toByteArray();
			}
			final ParseFile file = new ParseFile("profpic.png", image);
            // Upload the image into Parse Cloud
            file.saveInBackground();
			
          
          ParseQuery<ParseObject> query1 = ParseQuery.getQuery("Profile");
			query1.whereEqualTo("Username", un);
			query1.getFirstInBackground(new GetCallback<ParseObject>() {
                public void done(ParseObject object, ParseException e) {
                  if (object != null) 
                  {
                	  objid=object.getObjectId().toString();
                	  ...
                	  ParseQuery<ParseObject> query = ParseQuery.getQuery("Profile"); 
                     	...
                     	public void done(ParseObject update, ParseException e) {
                     	   if (e == null) 
                     	   {
                     	     update.put("Profile_Pic", file);
                     	     update.saveInBackground();
                     	   }
                     	   else
                     	   {
                     		  Toast.makeText(Pic_select2.this, "Something went wrong, please try again later",Toast.LENGTH_SHORT).show();
                     	   }
                     	}
                     	});
                  }
...
*/  		
         ...
         //   ParseObject imgupload = new ParseObject("_User");
          //     ParseObject user = new ParseObject("_User");
          //  ParseUser user = new ParseUser();
            //  "ImageName" and set the string
         //   imgupload.put("ImageName", "Profile_pic");

            //  "ImageFile" and insert the image
          //  user.put("Profile_Pic", file);
            ...
            Toast.makeText(Pic_select2.this, "Your profile picture has been updated. Check View Profile!",Toast.LENGTH_LONG).show();
			
			
			
			Intent intent = new Intent(Pic_select2.this, ProfileSettings.class);
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		case CROP_FROM_CAMERA:
			...
			Toast.makeText(Pic_select2.this, "Set As Profile Picture",
	...
	public void onBackPressed() {
	    super.onBackPressed();
	    Intent in =  new Intent(Pic_select2.this,ProfileSettings.class);
    	startActivity(in);
	    finish();
